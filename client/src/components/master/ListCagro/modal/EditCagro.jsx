...
const EditCagro = (props) => {
  ...
  const { updateCagroResult, updateCagroError } = useSelector(
  ...
  return (
    <Modal show={showModalCagro} onHide={handleCloseEditCagro}>
      ...
      <Form onSubmit={handleSubmit(handleUpdateCagro)} className="px-2">
        <Modal.Body>
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm="8">
              <Form.Control
                ...
                value={cagroName}
                onChange={(e) => setCagroName(e.target.value)}
              ></Form.Control>
            </Col>
          </Form.Group>
          ...
          <Form.Group as={Row} className="mb-3">
            ...
            <Col sm="8">
              <Form.Select
                ...
                value={cagroType}
                onChange={(e) => setCagroType(e.target.value)}
              >
          ...
          <Form.Group className="mb-3">
            <Form.Label htmlFor={`formCagroDesc${cagroId}`}>
              Description
            </Form.Label>
            <Form.Control
              as="textarea"
              ...
              rows={5}
              value={cagroDesc}
              onChange={(e) => setCagroDesc(e.target.value)}
              maxLength={255}
            />
          </Form.Group>
