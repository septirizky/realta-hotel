...
import { FaSwimmingPool, FaDumbbell, FaSpa, FaShip, FaSurprise, FaMicrophone, FaWater, FaUmbrellaBeach } from 'react-icons/fa';
     ...
     <Navbar bg="dark" variant="dark" expand="lg">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ml-auto nav-links">
          ...
          <Nav.Link href="#about" className="nav-link-custom">Account</Nav.Link>
    ...
    <div className="p-2">
        <div className="home" id="home">
            ...
            <div className="image_item">
                <img src={Hotel1} alt="" className="slide active" onClick={() => img(Hotel1)}/>
                <img src={Hotel2} alt="" className="slide" onClick={() => img(Hotel2)}/>
                <img src={Hotel3} alt="" className="slide" onClick={() => img(Hotel3)}/>
                <img src={Hotel4} alt="" className="slide" onClick={() => img(Hotel4)}/>
            </div>
            </div>
        </div>
    </div>
